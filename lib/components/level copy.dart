...
class Dungeon extends World with HasGameRef<PixelAdventure> {
  ...
  Dungeon({
    ...
    required List<List<String>> levelData,
  });

  // tiles
  late TiledComponent dungeon;
  ...
  FutureOr<void> onLoad() async {
    ...
    dungeon = await TiledComponent.load('level-03.tmx', Vector2.all(24),
        priority: -1);
  ...
  void _spawningObjects() {
    ...
    final spawnPointsLayer =
        dungeon.tileMap.getLayer<ObjectGroup>('Spawnpoints');
  ...
  void _addCollisions() {
    // Collision
    final collisionsLayer = dungeon.tileMap.getLayer<ObjectGroup>('Collisions');
